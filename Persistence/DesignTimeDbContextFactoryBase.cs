namespace Persistence
{
    ...
    {
        private const string ConnectionStringName = "ReactivitiesDatabase";
        private const string AspNetCoreEnvironment = "ASPNETCORE_ENVIRONMENT";

        public TContext CreateDbContext(string[] args)
        {
            var basePath = Directory.GetCurrentDirectory() + string.Format("{0}..{0}Reactivities", Path.DirectorySeparatorChar);
